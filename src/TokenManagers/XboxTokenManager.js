...
class XboxTokenManager {
  constructor (ecKey, cache, agent = undefined) {
    this.key = ecKey
  ...
  async getUserToken (accessToken, azure) {
    ...
    const ret = await fetch(Endpoints.XboxUserAuth, { method: 'post', headers, body, agent: this.agent }).then(checkStatus)
  ...
  async doSisuAuth (accessToken, deviceToken, options = {}) {
    ...
    const req = await fetch(Endpoints.SisuAuthorize, { method: 'post', headers, body, agent: this.agent })
  ...
  async getXSTSToken (tokens, options = {}) {
    ...
    const req = await fetch(Endpoints.XstsAuthorize, { method: 'post', headers, body, agent: this.agent })
    const ret = await req.json()
  ...
  async getDeviceToken (asDevice) {
    ...
    const ret = await fetch(Endpoints.XboxDeviceAuth, { method: 'post', headers, body, agent: this.agent }).then(checkStatus)
  ...
  async getTitleToken (msaAccessToken, deviceToken) {
    ...
    const ret = await fetch(Endpoints.XboxTitleAuth, { method: 'post', headers, body, agent: this.agent }).then(checkStatus)
